...
echo.    * Presionar (13)Activar la optimizacion de GTA V                                *
...
:op13
test&cls
for /f "delims=" %%i in ('dir /S /B "C:\GTA5.exe"') do (
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTA5.exe" /v "Version" /t REG_SZ /d "1.0" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTA5.exe" /v "Application Name" /t REG_SZ /d "GTA5.exe" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTA5.exe" /v "Protocol" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTA5.exe" /v "Local Port" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTA5.exe" /v "Local IP" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTA5.exe" /v "Local IP Prefix Length" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTA5.exe" /v "Remote Port" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTA5.exe" /v "Remote IP" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTA5.exe" /v "Remote IP Prefix Length" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTA5.exe" /v "DSCP Value" /t REG_SZ /d "46" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTA5.exe" /v "Throttle Rate" /t REG_SZ /d "-1" /f

for /f "delims=" %%i in ('dir /S /B "C:\GTAVLauncher.exe"') do (
Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\GTAVLauncher.exe\PerfOptions" /v "CpuPriorityClass" /t REG_DWORD /d "6" /f
REG ADD "HKCU\SOFTWARE\Microsoft\DirectX\UserGpuPreferences" /v "%%i" /t REG_SZ /d "GpuPreference=2;" /f
REG QUERY "HKCU\SOFTWARE\Microsoft\DirectX\UserGpuPreferences" /v "%%i" >nul
)
wmic process where name="GTAVLauncher.exe" CALL setpriority "256"
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTAVLauncher.exe" /v "Version" /t REG_SZ /d "1.0" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTAVLauncher.exe" /v "Application Name" /t REG_SZ /d "GTAVLauncher.exe" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTAVLauncher.exe" /v "Protocol" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTAVLauncher.exe" /v "Local Port" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTAVLauncher.exe" /v "Local IP" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTAVLauncher.exe" /v "Local IP Prefix Length" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTAVLauncher.exe" /v "Remote Port" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTAVLauncher.exe" /v "Remote IP" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTAVLauncher.exe" /v "Remote IP Prefix Length" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTAVLauncher.exe" /v "DSCP Value" /t REG_SZ /d "46" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\GTAVLauncher.exe" /v "Throttle Rate" /t REG_SZ /d "-1" /f

for /f "delims=" %%i in ('dir /S /B "C:\Supermarket Simulator.exe"') do (
Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\Supermarket Simulator.exe\PerfOptions" /v "CpuPriorityClass" /t REG_DWORD /d "6" /f
REG ADD "HKCU\SOFTWARE\Microsoft\DirectX\UserGpuPreferences" /v "%%i" /t REG_SZ /d "GpuPreference=2;" /f
REG QUERY "HKCU\SOFTWARE\Microsoft\DirectX\UserGpuPreferences" /v "%%i" >nul
)
wmic process where name="C:\Supermarket Simulator.exe" CALL setpriority "256"
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\Supermarket Simulator.exe" /v "Version" /t REG_SZ /d "1.0" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\Supermarket Simulator.exe" /v "Application Name" /t REG_SZ /d "Supermarket Simulator.exe" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\Supermarket Simulator.exe" /v "Protocol" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\Supermarket Simulator.exe" /v "Local Port" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\Supermarket Simulator.exe" /v "Local IP" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\Supermarket Simulator.exe" /v "Local IP Prefix Length" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\Supermarket Simulator.exe" /v "Remote Port" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\Supermarket Simulator.exe" /v "Remote IP" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\Supermarket Simulator.exe" /v "Remote IP Prefix Length" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\Supermarket Simulator.exe" /v "DSCP Value" /t REG_SZ /d "46" /f
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\Supermarket Simulator.exe" /v "Throttle Rate" /t REG_SZ /d "-1" /f
test&cls
goto main
test&cls
